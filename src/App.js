    ...
    render() {
        return (
            <div className="App">
                ...
                <button className="btnLeft" onClick={console.log('1')}></button>
                <button className="btnShoot" onClick={console.log('2')}></button>
                <button className="btnRight" onClick={console.log('3')}></button>
            </div>
        )
    }
}
